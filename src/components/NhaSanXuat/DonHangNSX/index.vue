                ...
                <tr>
                  ...
                  <td>
                    <div v-if="v.tinh_trang == 1" class="d-flex order-actions">
                      <a type="button" @click="moXacNhan(v)" title="Đang chuẩn bị hàng" class="ms-3 text-success"
                        data-bs-toggle="modal" data-bs-target="#xacNhanModal"><i class="fa-solid fa-check"></i></a>
                    </div>
                    <div v-if="v.tinh_trang == 4 || v.tinh_trang == 2 || v.tinh_trang == 3"
                      :disabled="v.tinh_trang == 4 || v.tinh_trang == 2 || v.tinh_trang == 3"
                      class="d-flex order-actions">
                      <a type="button" title="Đang chuẩn bị hàng" class="ms-3"><i class="fa-solid fa-check"
