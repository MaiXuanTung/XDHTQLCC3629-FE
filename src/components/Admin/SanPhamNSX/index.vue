                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="create_san_pham_nsx.ma_lo_hang" type="text"
                                                class="form-control" id="inputMaLoHang">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputNSX" class="col-sm-3 col-form-label">Ngày Sản Xuất</label>
                                        <div class="col-sm-9">
                                            <input v-model="create_san_pham_nsx.ngay_san_xuat" type="date"
                                                class="form-control" id="inputNSX">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <div class="col-sm-9">
                                                <input v-model="update_san_pham_nsx.ten_san_pham" type="text"
                                                    class="form-control" id="inputNSX">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="update_san_pham_nsx.hinh_anh" class="form-control"
                                                id="inputMaLoHang">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="update_san_pham_nsx.so_luong_ton_kho" type="text"
                                                class="form-control" id="inputNSX">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="update_san_pham_nsx.gia_ban" type="text"
                                                class="form-control" id="inputNSX">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="update_san_pham_nsx.don_vi_tinh" type="text"
                                                class="form-control" id="inputNSX">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
