                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <div class="d-flex order-actions">
                                                <a v-on:click="Object.assign(update_san_pham_nsx, v)" type="button"
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="create_san_pham_nsx.ngay_san_xuat" type="date" class="form-control"
                                                id="inputNSX">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputNSX" class="col-sm-3 col-form-label">Ngày Sản Xuất</label>
                                        <div class="col-sm-9">
                                            <input v-model="update_san_pham_nsx.ngay_san_xuat" type="date" class="form-control"
                                                id="inputNSX">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
