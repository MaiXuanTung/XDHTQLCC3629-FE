                    ...
                    <td v-else>Đại Lý</td> -->
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <div class="d-flex order-actions">
                                                <a v-on:click="Object.assign(update_dai_ly, v)" type="button"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <form class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input v-model="create_dai_ly.ten_cong_ty" type="text" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input v-model="create_dai_ly.email" type="email" class="form-control"
                                                id="inputEmail" placeholder="Nhập email">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputPassword" class="form-label">Password</label>
                                            <input v-model="create_dai_ly.password" type="password" class="form-control"
                                                id="inputPassword" placeholder="Nhập password">
                                        </div>
                                        <div class="col-6">
                                            <label for="inputAddress" class="form-label">Địa Chỉ</label>
                                            <input v-model="create_dai_ly.dia_chi" class="form-control"
                            ...
                            <div class="modal-footer">
                                ...
                                <button v-on:click="themMoiDaiLy()" type="button" class="btn btn-primary"
                ...
                <div class="modal fade" id="capNhatModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="update_dai_ly.ten_cong_ty" type="text" class="form-control"
                                                id="inputTenCongTy">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="update_dai_ly.email" type="email" class="form-control"
                                                id="inputEmail">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="update_dai_ly.mat_khau" class="form-control"
                                                id="inputMatKhau">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="update_dai_ly.dia_chi" class="form-control"
                                                id="inputDiaChi">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputSoDienThoai" class="col-sm-3 col-form-label">Số Điện
                                            Thoại</label>
                                        <div class="col-sm-9">
                                            <input v-model="update_dai_ly.so_dien_thoai" type="text"
                                                class="form-control" id="inputSoDienThoai">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                                <button v-on:click="updateDaiLy()" type="button" class="btn btn-primary"
