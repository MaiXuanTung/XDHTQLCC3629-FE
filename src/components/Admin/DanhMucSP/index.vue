                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <div class="d-flex order-actions">
                                                        <a v-on:click="Object.assign(update_danh_muc_sp, v)"
                                        ...
                                        <div class="border p-4 rounded">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputMaDanhMuc" class="col-sm-3 col-form-label">Mã Danh
                                                    Mục</label>
                                                <div class="col-sm-9">
                                                    <input v-model="update_danh_muc_sp.ma_danh_muc" type="text"
                                                        class="form-control" id="inputMaDanhMuc">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputTenDanhMuc" class="col-sm-3 col-form-label">Tên Danh
                                                    Mục</label>
                                                <div class="col-sm-9">
                                                    <input v-model="update_danh_muc_sp.ten_danh_muc" type="email"
                                                        class="form-control" id="inputTenDanhMuc">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-3 col-form-label">Tình Trạng</label>
                                                <div class="col-sm-9">
                                                    <select v-model="update_danh_muc_sp.tinh_trang"
                                                        class="form-control">
                                                        <option value="1">Hoạt Động</option>
                                                        <option value="0">Tạm Dừng</option>
                                                    </select>
