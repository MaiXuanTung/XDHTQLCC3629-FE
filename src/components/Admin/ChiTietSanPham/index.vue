            ...
            <tbody>
              <template v-for="(v, k) in list_chi_tiet" :key="k">
                <tr class="">
                  ...
                  <td>
                    <i style="font-size: 25px;" v-on:click="Object.assign(ghi_chu_sp, v)"
                  ...
                  <td>
                    <div class="d-flex order-actions">
                      <div class="d-flex order-actions">
                        <a v-on:click="Object.assign(update_chi_tiet, v)" type="button" title="Cập Nhật"
        ...
        <div class="modal fade" id="themMoiModal" tabindex="-1" aria-hidden="true" style="display: none;">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="card-body">
                <div class="border p-4 rounded">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <input v-model="create_chi_tiet.ma_don_hang" type="text" class="form-control" id="inputMaDonHang">
                    </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <input v-model="create_chi_tiet.ghi_chu" type="text" class="form-control" id="inputGhiChu">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputDonGia" class="col-sm-3 col-form-label">Đơn Giá</label>
                    <div class="col-sm-9">
                      <input v-model="create_chi_tiet.don_gia" class="form-control" id="inputDonGia">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputSoLuong" class="col-sm-3 col-form-label">Số Lượng</label>
                    <div class="col-sm-9">
                      <input v-model="create_chi_tiet.so_luong" type="text" class="form-control" id="inputSoLuong">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputDVT" class="col-sm-3 col-form-label">Đơn Vị Tính</label>
                    <div class="col-sm-9">
                      <input v-model="create_chi_tiet.don_vi_tinh" type="text" class="form-control" id="inputDVT">
                    </div>
                  </div>
                  <div class="row mb-3">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                <button v-on:click="themMoiChiTiet()" type="button" class="btn btn-primary" data-bs-dismiss="modal">Thêm
                  mới</button>
              </div>
            </div>
          </div>
        ...
        <div class="modal fade" id="capNhatModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="card-body">
                <div class="border p-4 rounded">
                  ...
                  <div class="row mb-3">
                    <label for="inputMaDonHang" class="col-sm-3 col-form-label">Mã Đơn Hàng</label>
                    <div class="col-sm-9">
                      <input v-model="update_chi_tiet.ma_don_hang" type="text" class="form-control" id="inputMaDonHang">
                    </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <label for="inputDonGia" class="col-sm-3 col-form-label">Đơn Giá</label>
                    <div class="col-sm-9">
                      <input v-model="update_chi_tiet.don_gia" type="text" class="form-control" id="inputDonGia">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputSoLuong" class="col-sm-3 col-form-label">Số Lượng</label>
                    <div class="col-sm-9">
                      <input v-model="update_chi_tiet.so_luong" type="text" class="form-control" id="inputSoLuong">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputDVT" class="col-sm-3 col-form-label">Đơn Vị Tính</label>
                    <div class="col-sm-9">
                      <input v-model="update_chi_tiet.don_vi_tinh" type="text" class="form-control" id="inputDVT">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label class="col-sm-3 col-form-label">Tình Trạng</label>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                <button v-on:click="updateChiTiet()" type="button" class="btn btn-primary" data-bs-dismiss="modal">Cập
                  Nhật</button>
              </div>
            </div>
          </div>
